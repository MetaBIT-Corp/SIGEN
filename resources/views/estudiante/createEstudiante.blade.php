...
@section("ol_breadcrumb")
    ...
    <li class="breadcrumb-item">Nuevo Estudiante</li>
@endsection
@section("main")
  <div class="row">
  ...
  <div class="col-md-8">
  <div class="card">
  <div class="card-header bg-default">Nuevo estudiante</div>
  <div class="card-body">
    <!-- Notificacion  -->
            ...
            <div class="form-group">
               <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="carnet" id="carnet" class="form-control" value="{{ old('carnet') }}" required>
                  </div>
                  <div class="col-md-6">
