                ...
                <form action="{{ route('pregunta.store',[$area->id]) }}" method="POST">
                    ...
                    <div class="form-group row">
                        <input class="form-control" hidden="" name="area_id" type="number" value="{{ $area->id }}">
                            ...
                            <div class="col-8">
                                <input class="form-control" id="pregunta" name="pregunta" placeholder="Pregunta" required="" type="text">
                                </input>
                            </div>
                        </input>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group offset-1">
                            <button class="btn btn-secondary mt-3" onclick="location.href='.'" type="button">
                                Cancelar
                            </button>
                        </div>
                    </div>
