...
@section("ol_breadcrumb")
    ...
    <li class="breadcrumb-item">Actualizar Docente</li>
@endsection
@section("main")
  <div class="row">
    ...
    <div class="card">
    <div class="card-header bg-default">Actualizar docente</div>
    <div class="card-body">
      <!-- Notificacion  -->
      ...
      <!-- Validaciones -->
        <form action="" method="POST">
          {{ csrf_field() }}
            <input type="hidden" name="id_pdg_dcn" value="{{$docente->id_pdg_dcn}}">
            ...
            <div class="form-group">
              <label for="nombre_docente"><b title="Campo Obligatorio">*</b>&nbsp;Nombre</label>
                <input type="text" name="nombre_docente" id="nombre_docente" class="form-control" value="{{ old('nombre_docente', $docente->nombre_docente) }}" required>
            </div>
            ...
            <div class="form-group">
               <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="carnet_dcn" id="carnet_dcn" class="form-control" value="{{ old('carnet_dcn', $docente->carnet_dcn) }}" required>
                  </div>
                  <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <textarea name="descripcion_docente" id="descripcion_docente" class="form-control">{{ old('descripcion_docente', $docente->descripcion_docente) }}</textarea>
            </div>
