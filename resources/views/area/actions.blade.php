<div>
	<a class="btn btn-success btn-sm mr-2 ml-2" @if($tipo_item=='Emparejamiento')href="{{ URL::signedRoute('pregunta.index', ['id_area' => $id_area ,'id_gpo'=>true]) }}" title="Listado Grupo Emparejamiento"@else href="{{ URL::signedRoute('pregunta.index', ['id_area' => $id_area ,'id_gpo'=>false]) }}" title="Listado preguntas"@endif>
